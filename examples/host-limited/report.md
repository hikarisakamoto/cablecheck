...
1. Result appears host-limited: close background load, disable CPU power saving, avoid USB adapters, rerun. Evidence from this run: max iperf3 CPU utilization 98.4% > 90%.
