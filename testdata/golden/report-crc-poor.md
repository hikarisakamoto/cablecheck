...
- **Score:** 50/100
- **Reason:** CRC-class receive errors incremented by 42 during the test.

| Rule | Category | Severity | Finding |
| --- | --- | --- | --- |
| PHY-02 | physical | poor | CRC-class receive errors incremented by 42 during the test. |
...
- **PHY-02** [physical/poor] CRC-class receive errors incremented by 42 during the test.
  - pc1: CRC-class error counters +42 during the test

## 19. Recommendations

1. Reseat both connectors and inspect for damage; replace the cable with a known-good Cat5e/Cat6 and rerun. Evidence from this run: pc1: CRC-class error counters +42 during the test.
